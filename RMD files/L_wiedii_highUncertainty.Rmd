...
Leopardus_wiedii_random <- generate_occ_uncertain(L_wiedii_Unc_naMean, lat_col = "decimalLatitude", lon_col = "decimalLongitude", lat_uncertainty = "lat_uncertainty", lon_uncertainty = "lon_uncertainty", taxa_col = "species")
...
nrow(L_wiedii_highUnc_naMean$lat_uncertainty)
