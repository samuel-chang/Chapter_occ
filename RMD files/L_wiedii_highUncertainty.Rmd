...
L_wiedii_highUnc_naNA <-
  dplyr::filter(L_wiedii_highUnc_naNA,
...
write.csv2(L_wiedii_high_CO_georanges_100, "~/GitHub/ENS Master/Chapter1/Chapter_uno/data/T_ornatus_CO_georanges_100.csv" )

L_wiedii_high_georanges_10 <-
  cbind(
    L_wiedii_high_naMean_geo_range_10,
...
write.csv2(L_wiedii_high_georanges_10, "~/GitHub/ENS Master/Chapter1/Chapter_uno/data/L_wiedii_high_georanges_10.csv" )
```
