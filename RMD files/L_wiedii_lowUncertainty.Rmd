...
write.csv(L_wiedii_low_georanges_100, "../data/L_wiedii_low_georanges_100.csv" )
...
```{r mean original data}
observed <- dplyr::select(L_wiedii_lowUnc_naMean, decimalLatitude, decimalLongitude, species)
(EOO.computing(observed, exclude.area = T, country_map = land)$EOO - mean(L_wiedii_low_naMean_geo_range_100$Mean_EOO))/sd(L_wiedii_low_naMean_geo_range_100$Mean_EOO)
```
