...
observed <- dplyr::select(L_wiedii_lowUnc, decimalLatitude, decimalLongitude, species)
(EOO.computing(observed)$EOO - mean(L_wiedii_low_naMean_geo_range_100$Mean_EOO))/sd(L_wiedii_low_naMean_geo_range_100$Mean_EOO)
```
