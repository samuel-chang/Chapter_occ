...
```{r datasets with high uncertainty }
#observed data set
...
L_wiedii_high_100georanges <-
  read_csv("Results/L_wiedii_low_100georanges.csv")

L_wiedii_high_1000georanges <-
  read_csv("Results/L_wiedii_high_1000georanges.csv")
```
...
(observed.EOO$EOO - mean(L_wiedii_high_100georanges$naMean_EOO)
...
(observed.EOO$EOO - mean(L_wiedii_high_100georanges$naZero_EOO)
